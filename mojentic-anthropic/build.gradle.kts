...
mavenPublishing {
    ...
    pom {
        name.set("Mojentic Anthropic Gateway")
        description.set("Anthropic Messages-API gateway for the Mojentic Kotlin Multiplatform agentic framework.")
...
kotlin {
    ...
    val xcf = XCFramework("MojenticAnthropic")
    listOf(iosX64(), iosArm64(), iosSimulatorArm64()).forEach { target ->
        target.binaries.framework {
            baseName = "MojenticAnthropic"
            xcf.add(this)
        }
    }
