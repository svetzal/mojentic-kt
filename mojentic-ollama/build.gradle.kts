...
mavenPublishing {
    ...
    pom {
        name.set("Mojentic Ollama Gateway")
        description.set("Ollama gateway for the Mojentic Kotlin Multiplatform agentic framework.")
...
kotlin {
    ...
    val xcf = XCFramework("MojenticOllama")
    listOf(iosX64(), iosArm64(), iosSimulatorArm64()).forEach { target ->
        target.binaries.framework {
            baseName = "MojenticOllama"
            xcf.add(this)
        }
    }
