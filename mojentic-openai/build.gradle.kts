...
mavenPublishing {
    ...
    pom {
        name.set("Mojentic OpenAI Gateway")
        description.set("OpenAI Chat Completions gateway for the Mojentic Kotlin Multiplatform agentic framework.")
...
kotlin {
    ...
    val xcf = XCFramework("MojenticOpenAi")
    listOf(iosX64(), iosArm64(), iosSimulatorArm64()).forEach { target ->
        target.binaries.framework {
            baseName = "MojenticOpenAi"
            xcf.add(this)
        }
    }
